...
// ------------------------------------------------------------
// Навигация по 9 экранам (Этап 6) — старый двухкнопочный UI.
// Оставлены для совместимости/тестов, в текущем UI не используются.
// ------------------------------------------------------------
int cycle_param(int current_screen);
int cycle_period(int current_screen);

// ------------------------------------------------------------
// Навигация одной кнопкой (новый UI: 4 экрана — main + 3 графика CO2)
// ------------------------------------------------------------
// Следующий экран по кругу: 0 → 1 → ... → n-1 → 0.
// current вне диапазона [0, n_screens) → 0 (защита от мусора в RTC memory).
// n_screens <= 0 → 0.
